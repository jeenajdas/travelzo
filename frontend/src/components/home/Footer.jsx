    ...
    <footer className="bg-gray-900 text-white pt-12 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-white font-bold text-2xl">Travelzo</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/my-bookings" className="text-gray-400 hover:text-white transition-colors duration-200">
                  My Bookings
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-gray-400 text-sm">
          <p>&copy; {new Date().getFullYear()} Travelzo. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
